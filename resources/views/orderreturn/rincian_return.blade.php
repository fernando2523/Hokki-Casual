        ...
        <div class="col-xl-12 mb-3">
            <div class="card" align="center">
                <div class="card-body d-flex align-items-center text-white m-5px bg-success bg-opacity-10">
                    <div class="flex-fill">
                        <h5 class="text-white" style="margin-bottom: -2px;">{{ $getdata[0]->id_reseller }}</h5>
                    </div>
                </div>
                ...
                <table class="table-sm table-bordered mb-0" style="width: 100%" id="tb_rincianreturn">
                    <thead style="font-size: 11px;">
                        <tr>
                            ...
                            <th class="text-center" width="5%" style="color: #a8b6bc !important;">SIZE LAMA
                            </th>
                            <th class="text-center" width="5%" style="color: #a8b6bc !important;">QTY LAMA
                            </th>
                            <th class="text-center" width="5%" style="color: #a8b6bc !important;">SIZE BARU
                            </th>
                            <th class="text-center" width="5%" style="color: #a8b6bc !important;">QTY BARU
                            </th>
                        </tr>
                    </thead>
...
<script type="text/javascript">
    $(function() {
        var table = $('#tb_rincianreturn').DataTable({
            ...
            processing: false,
            serverSide: true,
            ajax: "/table_rincian_return/{{ $id_transaction }}",
            columns: [{
                data: 'DT_RowIndex',
                name: 'id',
