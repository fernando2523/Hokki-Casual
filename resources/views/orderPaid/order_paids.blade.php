...
@section('container')
    <div id="content" class="app-content">
        <div class="d-flex align-items-center">
            <div>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">RESELLER PAID PAGE</li>
                </ul>
                        ...
                        <table class="table-sm mb-0 mt-2" style="width: 100%">
                            <thead class="thead-custom">
                                <tr class="text-white">
                                    ...
                                    <th colspan="4" class="text-center text-white" width="25%">SUB
                                        TOTAL
                                    </th>
                                </tr>
                            </thead>
        ...
        <form class="was-validated" method="POST" action="/cancel_order_paid">
        ...
        <form class="" method="POST" action="/refund_order_paid">
            @csrf
        ...
        <form class="" method="POST" action="/retur_order_paid">
            @csrf
