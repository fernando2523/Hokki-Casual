...
<body>
    <table width="30%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><span class="style12"><strong>Invoice </strong></span><span class="style12"><strong>:
    ...
    <table width="30%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center">
                <div align="center"><span class="style10"><B>Admin : <span class="style12">{{ $details[0]->users }}</B>
            </td>
        </tr>
        <tr>
            <td align="center">
